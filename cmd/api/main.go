...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "4d7df59fd831cf", "SMTP username")

	flag.StringVar(&cfg.smtp.password, "smtp-password", "4f54c8b9eae4ea", "SMTP password")

	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.fiston.net>", "SMTP sender")
